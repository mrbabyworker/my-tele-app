...
const BOTTOM_TABS: Array<{
...
}> = [
  {
    ...
    href: "/works",
    icon: (
      <i className="hgi hgi-solid hgi-rounded hgi-source-code-circle" />
    ),
  },
  {
    id: "main",
    label: "Main",
    href: "/",
    icon: <i className="hgi hgi-solid hgi-rounded hgi-user-circle" />,
  },
  {
    id: "assistant",
    label: "Assistant",
    href: "/assistant",
    icon: (
      <i className="hgi hgi-solid hgi-rounded hgi-bubble-chat-spark-01" />
    ),
  },
];
